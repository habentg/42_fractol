...
/*   Updated: 2023/08/15 13:37:22 by fkidane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{ /* we can use for burning ship as well --- keep it in mind*/
    ...
    m->c_re = 0.0; // real part of c in the equition Zn+1 = Zn**2 + C; where C = re + im
	m->c_im = 0.0; // imaginary part of the above
	m->n_re = 0.0;
	m->n_im = 0.0;
